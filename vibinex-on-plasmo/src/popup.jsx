...
const IndexPopup = () => {
  const version = chrome.runtime.getManifest().version; //to update the version number in the footer
  const [data, setData] = useState("");
  // FIXME: Temporarily converted file to JSX for testing. Needs to be converted back to TSX
